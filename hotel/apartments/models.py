...
class Application(models.Model):
    ...
    apart_service = models.ForeignKey(ApartHotelService, verbose_name="Услуги апарт-отеля", on_delete=models.SET_DEFAULT, default=0, blank=True, null=True, related_name="apart_services")
